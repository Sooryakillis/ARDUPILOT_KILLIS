...
#define CHIBIOS_BOARD_NAME "KILLIS_TEST_5"
...
#define HAL_SPI_BUS_LIST HAL_SPI4_CONFIG


// SPI device table
#define HAL_SPI_DEVICE0  SPIDesc("icm20602"       ,  0,  1, PAL_LINE(GPIOE,11U), SPIDEV_MODE3,   1*MHZ,   4*MHZ)
...
#define HAL_GPIO_PIN_BATT2_CURRENT_SENS   PAL_LINE(GPIOA,6U)
#define HAL_GPIO_PIN_BATT2_VOLTAGE_SENS   PAL_LINE(GPIOA,4U)
#define HAL_GPIO_PIN_BATT_CURRENT_SENS    PAL_LINE(GPIOA,5U)
...
#define STM32_TIM_TIM15_UP_DMA_STREAM  STM32_DMA_STREAM_ID(2, 3)
#define STM32_TIM_TIM15_UP_DMA_CHAN    STM32_DMAMUX1_TIM15_UP
#define STM32_TIM_TIM4_UP_DMA_STREAM   STM32_DMA_STREAM_ID(2, 2)
#define STM32_TIM_TIM4_UP_DMA_CHAN     STM32_DMAMUX1_TIM4_UP
#define STM32_TIM_TIM5_UP_DMA_STREAM   STM32_DMA_STREAM_ID(2, 1)
#define STM32_TIM_TIM5_UP_DMA_CHAN     STM32_DMAMUX1_TIM5_UP
#define STM32_TIM_TIM8_UP_DMA_STREAM   STM32_DMA_STREAM_ID(2, 4)
#define STM32_TIM_TIM8_UP_DMA_CHAN     STM32_DMAMUX1_TIM8_UP
#define STM32_UART_UART4_RX_DMA_STREAM STM32_DMA_STREAM_ID(1, 4)
...
#define STM32_UART_UART7_TX_DMA_STREAM STM32_DMA_STREAM_ID(1, 6)
...
#define STM32_UART_USART2_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 0)
...
/* PORTA:
 ...
 PA5 BATT_CURRENT_SENS ADC1 ADC1_IN19
 PA6 BATT2_CURRENT_SENS ADC1 ADC1_IN3
